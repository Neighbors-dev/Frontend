...
/* export default function CollectionIntro() {
  ...
  return (
    <div
      className={twMerge(
        'max-w-600 fixed inset-0 z-10 overflow-hidden transition-[visibility] duration-300',
        showCollectionIntro
    ...
    >
      <div className="absolute bottom-0 left-0 w-full">
        <article
          className={twMerge(
            'flex h-[395px] flex-col gap-5 rounded-tl-[20px] rounded-tr-[20px] bg-neutral-80 px-8 py-6 transition-transform duration-300',
            showCollectionIntro ? 'translate-y-0' : 'translate-y-full'
          )}
        >
          <p className="label-medium text-center text-white">
